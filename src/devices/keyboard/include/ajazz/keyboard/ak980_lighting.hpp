 ...
 * — see [`docs/protocols/keyboard/ak980pro_vendor.md`](../../../../../docs/protocols/keyboard/ak980pro_vendor.md)
 * §3.4 + §3.4.1.
 *
 ...
 * `0x20 0x04`) — see [`ak980pro_mui_dll.md`](../../../../../docs/protocols/keyboard/ak980pro_mui_dll.md).
 */
#pragma once
...
inline constexpr AK980LightingMode kAK980LightingDefaultMode =
    AK980LightingMode::Rotating;
