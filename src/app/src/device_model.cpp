...
QVariant DeviceModel::data(QModelIndex const& index, int role) const {
    ...
    switch (role) {
        case ModelRole:     return QString::fromStdString(d.model);
        case CodenameRole:  return QString::fromStdString(d.codename);
        case FamilyRole:    return static_cast<int>(d.family);
        case VidRole:       return d.vendorId;
        case PidRole:       return d.productId;
        case ConnectedRole: return false;  // TODO: live enumeration via hid_enumerate
        default:            return {};
    }
}
