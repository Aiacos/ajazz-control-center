...
| [AJAZZ AKP05E (Stream Dock Plus)](docs/protocols/streamdeck/akp05.md) | `0x0300:0x3004` | 🟠 partial | Per-key display, Encoder / dial, Touch strip, Macros | Real retail AKP05E. Hot-plug capture 2026-05-13 surfaced this PID as 'Ajazz HOTSPOTEKUSB HID DEMO' (white-label dev string), which led to a brief mis-filing as the 6-key 'akp03_variant_3004'. A live CRT VER handshake on 2026-05-20 returned firmware string 'V3.AKP05E.01.007' — confirming AKP05E, protocol_version 3 (1024-byte packets), 10 keys (2x5) + 4 encoders + LCD touch strip. Routed through makeAkp05. |
