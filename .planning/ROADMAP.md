...
**Plans**: TBD · **Phase notes**: Can build early against a MockDevice (no hardware). Land transport/auth and actions as separate slices. **UI hint**: no
...
| 17. Plugin Protocol Completion              | v1.3      | 0/?            | Not started      | —          |
