...
| `resources/linux/70-ajazz.rules`                             | Possibly add `idVendor=="0c45"` `idProduct=="7016"` rule if Scenario A and a fresh VID prefix is needed (0x0c45 prefix already present — check).                                                  |
