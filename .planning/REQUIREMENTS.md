...
- [x] **PLUGIN-05**: The `passHello` + salt/challenge auth handshake is implemented (`sha256(password+salt)`; reject after N bad attempts; no TLS — loopback-only by design; sdk §4.5).
