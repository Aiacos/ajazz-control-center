...
| 4.4 | P2 | `update_image` null-clear ignores Encoder/touch; paints regardless of selected profile/device | F (clear); device-gate O |
...
| 5.2 | P2 | `set_settings` store-only: brightness/sleep sliders in OpenDeck Settings are inert | F (brightness) / O (sleep, autolaunch) |
