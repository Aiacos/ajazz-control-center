...
2. AKP03R rev. 2 — confirm 1024-byte packet size on v3 firmware.
3. MBox-N4 Pro — capture per-key RGB control packets.
4. MBox-N6 — confirm key count (6? or 10 with some non-LCD?).
5. K1Pro / Create_Pro keyboards — capture the LCD-bar protocol.
