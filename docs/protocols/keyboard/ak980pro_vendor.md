...
| 2      | 0x5A (magic)                                                                                                                                                                                                                                                                                                                       |
| 3      | year encoded modulo 2000 (vendor: `year % 2000`; our impl: `(year >= 2000) ? year - 2000 : 0`). Functionally equivalent for every calendar year 2000-2255; our variant is safer for pre-2000 inputs (no uint8 wrap). The 2026-05-18 audit confirmed: same wire byte for all real-world inputs the host's std::chrono will produce. |
| 4      | month (1-12)                                                                                                                                                                                                                                                                                                                       |
| 5      | day (1-31)                                                                                                                                                                                                                                                                                                                         |
| 6      | hour (0-23)                                                                                                                                                                                                                                                                                                                        |
| 7      | minute (0-59)                                                                                                                                                                                                                                                                                                                      |
