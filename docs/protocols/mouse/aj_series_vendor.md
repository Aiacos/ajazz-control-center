...
| Screen / LCD            | `0x25` / `0x29` chunked                                                                         | image frames                              | `0x25` chunked RGB565      | **YES** (2026-05-18: `buildSetTftLcdData` + `aj_series_tft_pipeline` clock+DPI face; `IClockCapable::setTime` drives it via TimeSyncService) |
