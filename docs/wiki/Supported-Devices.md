...
<!-- BEGIN AUTOGEN: stats -->
**35 devices** across 1 dongle, 3 keyboard, 11 mouse, 20 streamdeck — 11 functional, 20 scaffolded, 2 probed, 2 partial.
<!-- END AUTOGEN: stats -->
...
| mouse | [AJAZZ AJ159PRO 2.4G 8K](docs/protocols/mouse/aj_series_opcode_table.md) | `0x3151:0x402d` | — | — | 🟡 scaffolded | dpi, rgb |
...
| [AJAZZ AJ159PRO 2.4G 8K](docs/protocols/mouse/aj_series_opcode_table.md) | `0x3151:0x402d` | 🟡 scaffolded | DPI stages, RGB backlight | AJ159 PRO (2.4G 8K, PAW3395 sensor) reported in issue #75. PID 0x402d is in the same 0x3151 APEX block and rides the shared AJ-series backend, so it enumerates on the existing wire format. PROVISIONAL: no local hardware; capabilities gated to dpi+rgb (matching the scaffolded APEX 2.4G sibling) until a USB capture from the reporter confirms DPI/RGB/battery round-trips. |
