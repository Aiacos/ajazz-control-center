# Publishing to Windows package managers

The Windows MSI is built and published on every tagged release
(`.github/workflows/release.yml`). Getting it into **winget** and **Chocolatey**
is a separate, manual, moderated submission per package manager — neither is
automatic, and both go through human/automated review before users can install.
